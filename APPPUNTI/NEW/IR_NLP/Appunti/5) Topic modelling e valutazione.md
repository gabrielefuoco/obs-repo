...
- **Dato un documento \(D\), scegliamo un topic \(Z\) secondo la probabilità condizionata $\text{Pr}(z|d)$.**
- **Dato il topic \(Z\), selezioniamo un segmento \(S\) con probabilità $\text{Pr}(s|z)$ .**
- **Dato il topic \(Z\), possiamo anche scegliere una parola \(W\) con probabilità $\text{Pr}(w|z)$.**
- **Dato un segmento \(S\), scegliamo una parola \(W\) con probabilità $\text{Pr}(w|s)$ .**
