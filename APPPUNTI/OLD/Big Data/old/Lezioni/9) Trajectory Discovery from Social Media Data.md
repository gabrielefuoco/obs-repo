...
- **Scoperta dei luoghi più visitati** e degli eventi più frequentati: Analisi dei dati per identificare i luoghi ed eventi con maggiore affluenza.
- **Scoperta di insiemi di luoghi/eventi più frequentati** insieme: Estrazione di insiemi di luoghi visitati in combinazione o eventi partecipati collettivamente.
- **Scoperta di pattern di mobilità** tra i luoghi e sequenze di eventi frequentati: Identificazione di comportamenti di mobilità e sequenze rilevanti di partecipazione.
- **Scoperta di origine e destinazione** dei visitatori: Studio dei flussi di provenienza e destinazione per comprendere l'impatto turistico.
...
### Definizione dei luoghi di interesse (P)
...
### Raccolta e pre-elaborazione degli elementi geo-taggati (G)
...
### Analisi dei dati e mining delle traiettorie
...
## Definizione dei luoghi di interesse
...
## Raccolta degli elementi geo-taggati
...
- **Pulizia**: rimozione di tweet con posizioni inaffidabili.
- **Selezione**: eliminazione di re-tweet e tweet non pertinenti.
- **Trasformazione**: mantenuto un solo tweet per utente per partita per semplificare l'analisi.
